...
def main():
    ...
    from hid_defender.keystroke_monitor import KeystrokeMonitor, PYNPUT_AVAILABLE
    from hid_defender.device_monitor import get_macos_usb_devices
    from hid_defender.device_validator import (
        get_whitelist, run_baseline_setup, parse_device, 
        evaluate, should_debounce
    )
    from hid_defender.alert_system import play_alert_sound, show_alert, lock_workstation
